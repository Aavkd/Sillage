# Transcript — Conception

> Document de conception issu de 6 rounds de questions/réponses.
> Destiné à servir d'entrée à une passe de design (identité visuelle volontairement laissée ouverte)
...
### Interface
- **Thème** — à définir par le design
- **Langue de l'interface** — français *(hypothèse, cf. §9)*
...
- **Nom de l'application.** « Transcript » est le nom du dossier de travail, pas nécessairement
  celui du produit.
- **Identité visuelle** — passe de design. Deux contextes utiles : AETHER
  (`MANTARA/DESIGN SYSTEM/AETHER`) existe déjà, et l'app est un outil de **lecture et d'édition de
  texte long**, dont le centre de gravité diffère nettement d'un tableau de bord.
- **Framework frontend** — à choisir avec le design.
